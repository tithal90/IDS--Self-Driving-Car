...
public class login 
{
	public static void main(String aa[])
	{
	   ...
	   {	
		...
		log1.setTitle("An intrusion detection system against malicious attacks on the communication network");	
		String host1="";
...
//		getContentPane().setLayout(null);
		...
		agenttext3=new JLabel("An intrusion detection system against malicious attacks on the communication network");
...
//////////
		...
		agenttext1=new JLabel("An intrusion detection system against malicious attacks on the communication network");
